...
class TrainingArguments(transformers.Seq2SeqTrainingArguments):
    ...
    weight_decay: float = field(default=0.0, metadata={"help": ''}) # use lora dropout instead for regularization if needed
...
def local_dataset(dataset_path):
    ...
    if dataset_path.endswith('.json'):
        full_dataset = Dataset.from_json(path_or_paths=dataset_path, field='rows')
    elif dataset_path.endswith('.jsonl'):
        full_dataset = Dataset.from_json(filename=dataset_path, format='jsonlines')
