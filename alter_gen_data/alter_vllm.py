...
class spe_thinking_vllm:
    def __init__(self, **config):
        ...
        if config['alter_model_name'] is not None: 
            self.speculative_model = create_ray_model(config['alter_model_name'], config['alter_model_gpu'])
    ...
    def alter_generate(self, messages=None, max_tokens=100, temperature=0.6, top_k=50, top_p=0.95):
